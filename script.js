...
const translations = {
    it: {
        ...
        "where-to-stay-text": "Consigliamo di soggiornare a Napoli, nel centro storico. Organizzeremo un servizio navetta per portarvi alla location—maggiori dettagli a breve!",
    ...
    en: {
        ...
        "where-to-stay-text": "We recommend staying in Naples, around the historic center. We'll organize shuttle service to take you to the venue—more details coming soon!",
    ...
    pt: {
        ...
        "where-to-stay-text": "Recomendamos ficar em Nápoles, ao redor do centro histórico. Organizaremos um serviço de transporte para levá-los ao local—mais detalhes em breve!",
